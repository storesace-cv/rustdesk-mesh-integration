...
if [[ ${#log_dirs[@]} -eq 0 ]]; then
  echo "[Step-4] Nenhum log encontrado em $LOCAL_LOG_DIR ou $DEPLOY_LOG_DIR. Corre os passos anteriores primeiro." >&2
  exit 1
fi
...
[Step-4] Incluídos: ${log_dirs[*]} (originais mantêm-se em $LOG_ROOT)
EOF2
